...
class DiffSepformer_1(sb.Brain):
    ...
    def compute_forward(self, mix, targets, stage, noise=None):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            self.diff_loss.data = torch.tensor(0).to(self.device)
            if self.hparams.diff_mode == 'multiple':
                ...
                for t in range(T - 1, -1, -1):
                    ...
                    self.diff_loss += self.compute_diff_loss(transformer_predictions, transformer_targets) * self.hparams.diff_loss_coefficient

        ...
        for set in set_types:
            ...
            for i in range(hparams['num_spks']):
                ...
                for wav_name in tqdm(os.listdir(in_dir)):
                    ...
                    min_source = min(min_source, min(wav))
                    max_source = max(max_source, max(wav))

                    print('The max of source is %f and the min of source is %f' % (max_source, min_source))

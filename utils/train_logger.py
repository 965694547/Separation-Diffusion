...
class TrainLogger:
    ...
    def log_stats(
        self,
        stats_meta,
        train_gen_stats=None,
        train_disc_stats=None,
        valid_gen_stats=None,
        valid_disc_stats=None,
        test_stats=None,
        verbose=False,
    ):
...
class FileTrainLogger(TrainLogger):
    ...
    def log_stats(
        ...
        for dataset, stats in [
            ("train_gen", train_gen_stats),
            ("train_disc", train_disc_stats),
            ("valid_gen", valid_gen_stats),
            ("valid_disc", valid_disc_stats),
            ("test", test_stats),
        ]:
